...
<template>
  <div class="container contact">
    <div class="eyebrow">▶ /contact · email is open · dms are mostly</div>
    <h1>say hi<span class="dot">.</span></h1>
    <p class="lede">
    ...
    <div class="grid">
      <div>
        <h2>the open ones</h2>
        <div class="links">
          <a v-for="s in SOCIAL" :key="s.k" class="link fx-glitch" :href="s.href" target="_blank" rel="noopener">
      ...
      <div>
        <h2>im / messengers</h2>
        <div class="im-card">
          <div v-for="m in IM" :key="m.name" class="row">
            <span>◆ {{ m.name }}</span>
    ...
    <div class="footer-note" style="margin-top: 64px">
