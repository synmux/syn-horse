  ...
  <Teleport to="body">
    <Transition name="boot-fade" @after-leave="onTransitionAfterLeave">
      ...
      >
        ...
        <pre
          aria-hidden="true"
          class="font-display text-[20px] leading-[1.35] tracking-[0.02em] text-paper whitespace-pre-wrap sm:text-[24px]"
        >{{ printed }}<span v-if="visible" class="boot-cursor">▍</span></pre>
      </div>
    </Transition>
  </Teleport>
</template>
