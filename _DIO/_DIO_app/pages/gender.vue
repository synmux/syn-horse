  ...
  <div>
    ...
    <div class="space-y-6">
      <div class="text-center">
        <h1 class="text-2xl font-bold mb-4 bg-gradient-to-r from-pink via-mauve to-blue bg-clip-text text-transparent">
          Hi, I'm Non-Binary!
        </h1>
        <p class="text-xl text-subtext1 mb-4">I use <strong class="text-pink">they/them/their</strong> pronouns.</p>
      ...
      <GenderInfoCard title="🤔 Non-What?" color="pink">
        <p class="text-text leading-relaxed">
          ...
          is an umbrella term for gender identities that don't fit neatly into the categories of "man" or "woman." It's
          about existing outside the traditional gender binary.
        </p>
        <p class="text-text leading-relaxed">
        ...
        <div class="bg-pink/20 p-4 rounded-lg border border-pink/30">
          <p class="text-pink text-sm">
            💡 <strong>Pro tip:</strong> For brevity, people like me often use the contraction 'enby' (singular) or
            'enbies' (plural) to refer to ourselves - the spoken form of "NB", for "Non Binary".
          </p>
        </div>
      </GenderInfoCard>
      ...
      <GenderInfoCard title="🏳️‍⚧️ So Are Non-Binary People Transgender?" color="purple">
        ...
        <p class="text-text leading-relaxed">
          ...
          struggle. Non-binary people do experience dysphoria and have trouble passing, but it's different from someone
          who is binary transgender.
        </p>
      </GenderInfoCard>
      ...
      <GenderInfoCard title='🙄 "But There Are Only Two Genders!"' color="red">
        <p class="text-text leading-relaxed">
          ...
          here. Sex is determined by your genes, and relates to the biological differentiation of your body. Gender is
          distinct, and refers to a fairly nebulous psychological, cultural, and sociological identity. 🧬
        </p>
        <p class="text-text leading-relaxed">
        ...
        <div class="bg-red/20 p-4 rounded-lg border border-red/30 space-y-2">
          <p class="text-red">
            <Icon name="i-heroicons-exclamation-circle" class="font-bold mr-2 text-red" />
