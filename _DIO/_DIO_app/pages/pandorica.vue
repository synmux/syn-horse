<template>
  <div>
    <div class="text-center space-y-6">
      <div
        class="bg-surface0/80 border border-surface2 rounded-lg p-8 shadow-2xl backdrop-blur-sm"
      >
        <Icon
          name="i-mdi-shield-check"
          class="text-green w-16 h-16 mx-auto mb-4"
        />
        <h2 class="text-text font-bold text-2xl mb-4">Access Granted!</h2>
        <p class="text-subtext0 leading-relaxed">
          This page is protected by the access control middleware. Since the
          condition currently returns
          <code class="bg-surface1 px-2 py-1 rounded">true</code>, you can see
          this content.
        </p>
      </div>

      <div
        class="bg-surface1/60 border border-surface2 rounded-lg p-6 backdrop-blur-sm"
      >
        <h3 class="text-text font-semibold text-lg mb-3">
