<template>
  <Teleport to="body">
    <Transition
      ...
      @before-leave="clearAutoClose"
    >
      <div
        v-if="isVisible"
        class="fixed inset-0 z-[9999] flex items-center justify-center bg-base/95 backdrop-blur-sm"
      >
        <div class="max-w-4xl mx-auto p-8 text-center">
                ...
                <div class="flex items-start gap-6">
                  ...
                  <div class="flex-1">
                    ...
                    <p class="text-2xl text-subtext0">
                      Don't just close this window - completely quit your
                      browser application.
                    </p>
                    <div class="mt-4 p-4 bg-surface0 rounded-lg">
                      <p class="text-xl">
                        <strong>On Windows:</strong>
                        Press Alt+F4 or use File → Exit<br>
                        <strong>On Mac:</strong>
                        Press Cmd+Q or use Safari/Chrome → Quit<br>
              ...
              <div class="card-body">
                <div class="flex items-start gap-6">
                  ...
                  <div class="flex-1">
                    ...
                    <p class="text-2xl text-subtext0">
                      After quitting, open your browser again and try visiting
                      the website.
                    </p>
                  </div>
                </div>
              ...
              <div class="card-body">
                <div class="flex items-start gap-6">
                  ...
                  <div class="flex-1">
                    ...
                    <p class="text-2xl text-subtext0">
                      If the website is still blocked after reopening your
                      browser, press the refresh button (F5 or Cmd+R) and it
                      should work.
                    </p>
                  </div>
                </div>
          ...
          <div class="mt-8 flex justify-center gap-4">
            <button
              class="btn btn-primary btn-lg text-2xl px-8 py-4"
              @click="handleClose"
            >
