<template>
  <div class="space-y-6">
    <div class="text-center">
      <h1
        class="text-2xl font-bold mb-4 bg-gradient-to-r from-yellow via-orange to-red bg-clip-text text-transparent"
      >
        The API That Nobody Asked For
      </h1>
      <p class="text-xl text-subtext1 mb-4">
        This personal site has an
        <strong class="text-yellow">overengineered API</strong>.
      </p>
    ...
    <ApiInfoCard title="🤨 What's This About?" color="yellow">
      ...
      <p class="text-text leading-relaxed">
        It started as a simple way to serve some images and somehow evolved into
        a full-blown JWT-authenticated, Cloudflare Workers-powered,
        over-engineered monster. But hey, at least it's fast. ⚡
      </p>
      <p class="text-text leading-relaxed">
        The API powers various features on this site and provides programmatic
        access to some services. It's built on Nuxt 3, runs on Cloudflare's edge
        network, and has more authentication than a government facility.
      </p>
      <div class="bg-yellow/20 p-4 rounded-lg border border-yellow/30">
        <p class="text-yellow text-sm">
          💡 <strong>Fun fact:</strong> This API probably handles more
          authentication flows than actual requests.
        </p>
      </div>
    </ApiInfoCard>
    ...
    <ApiInfoCard title="🔐 Authentication" color="purple">
      ...
      <div class="mt-4">
        ...
        <p class="text-sm text-subtext0 mt-2">
          Pass your JWT as a Bearer token or a <code>token</code> GET parameter.
        </p>
      </div>
    </ApiInfoCard>
    ...
    <ApiInfoCard title="🌍 Public Endpoints" color="green">
      <p class="text-text leading-relaxed mb-4">
        These endpoints are available to everyone. Use them responsibly, or
        don't - I'm not your dad.
      </p>
      <div class="space-y-4">
        <div>
          <h3 class="text-green font-semibold mb-2">Health Check</h3>
          <p class="text-sm text-subtext0 mt-2">
            The classic ping-pong. Confirms the API hasn't caught fire and
            returns some information about your request.
          </p>
          <p class="text-sm text-subtext0 mt-2">
        ...
        <div>
          ...
          <p class="text-sm text-subtext0 mt-2">
            Generates dashboard data for dashboard apps which display
            dashboards.
          </p>
        </div>
      </div>
    ...
    <ApiInfoCard title="🚪 Protected Endpoints" color="red">
      <p class="text-text leading-relaxed mb-4">
        These endpoints require authentication. Without proper tokens, you'll
        get a 401 faster than you can say "unauthorized".
      </p>
      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <p class="text-sm text-subtext0 mb-2">
            Got a ticket with a description just containing a URL, image, or
            single sentence of text? Let AI go into detail for you.
          </p>
        </div>
        <div>
    ...
    <ApiInfoCard title="🚀 Getting Started" color="cyan">
      ...
      <div class="bg-cyan/20 p-4 rounded-lg border border-cyan/30 mt-4">
        <p class="text-cyan text-sm">
          ...
          The API runs on Cloudflare Workers, so it's distributed globally.
          You'll always hit the nearest edge location.
        </p>
      </div>
    </ApiInfoCard>
