...
- BREAKING: `make browser exports the default` — v13 changed to make browser exports the default, impacting how modules are consumed in browser environments [source](./.skilld/repos/uuidjs/uuid/releases/CHANGELOG.md:L4)

- BREAKING: `update to typescript@5.2` — v12 updated to TypeScript 5.2, potentially requiring type definition adjustments [source](./.skilld/repos/uuidjs/uuid/releases/CHANGELOG.md:L9)

- BREAKING: `remove CommonJS support` — v12 removed CommonJS support, requiring migration to ESM for module imports [source](./.skilld/repos/uuidjs/uuid/releases/CHANGELOG.md:L10)
