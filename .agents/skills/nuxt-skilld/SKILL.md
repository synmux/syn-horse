...
This output is formatted as a markdown file ready to be written to `/Users/dave/src/github.com/synmux/syn-horse/.Codex/skills/nuxt-skilld/.skilld/_BEST_PRACTICES.md`. The practices span 5 feature areas (SSR/hydration, data fetching, routing/navigation, module development, error handling) and prioritize production-ready patterns with documented sources from maintainer-confirmed discussions and closed issues.
<!-- /skilld:best-practices -->
