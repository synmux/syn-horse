---
name: anthropic-ai-Codex-skilld
description: 'ALWAYS use when writing code importing "@anthropic-ai/Codex". Consult for debugging, best practices, or modifying @anthropic-ai/Codex, anthropic-ai/Codex, anthropic-ai Codex, anthropic ai Codex, Codex-2.1.88, Codex 2.1.88.'
metadata:
  version: 2.1.131
  generated_at: 2026-05-06
---

# Exhen/Codex-2.1.88 `@anthropic-ai/Codex@2.1.131`
...
Use `skilld search "query" -p @anthropic-ai/Codex` instead of grepping `.skilld/` directories. Run `skilld search --guide -p @anthropic-ai/Codex` for full syntax, filters, and operators.

<!-- skilld:best-practices -->

## Best Practices for @anthropic-ai/Codex

Best practices extracted from the @anthropic-ai/Codex package documentation and SDK usage patterns.
...
Use Codex's structured output mode (`response_format: "json"`) for APIs that feed into downstream systems. Validate the output schema before processing to prevent data pipeline failures.
